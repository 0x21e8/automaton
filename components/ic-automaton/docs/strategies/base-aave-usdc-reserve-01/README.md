# Base Aave USDC Reserve (`base-aave-usdc-reserve-01`)

Low-complexity Base reserve strategy for parking surplus USDC on Aave V3 and withdrawing it when survival runway or reallocation policy requires.
