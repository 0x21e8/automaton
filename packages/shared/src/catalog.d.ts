...
export declare const CATALOG_ENTRY_STATUSES: readonly ["available", "coming_soon"];
export declare const REPOSITORY_STRATEGY_STATUSES: readonly ["active", "deprecated", "revoked"];
